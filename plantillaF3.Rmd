...
En este caso, el valor p es 0.05319, que es ligeramente mayor que 0.05. Por lo tanto, no rechazas la hipótesis nula. No tienes suficiente evidencia para afirmar que la media de la proporción de unidades ocupadas por el propietario y construidas antes de 1940 es diferente de 71.
...
Dado que el valor *p* es ligeramente mayor que *0.05* y el intervalo de confianza incluye 71, no tienes suficiente evidencia para rechazar la hipótesis nula. Esto significa que no puedes concluir que la media de la proporción de unidades ocupadas por el propietario y construidas antes de 1940 sea diferente de 71.
